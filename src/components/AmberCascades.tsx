  ...
  function render(timestamp: number) {
    ...
    for (const col of columns) {
      ...
      for (let j = 0; j < col.length; j++) {
        ...
        if (j === 0) { r = 30; g = 247; b = 193; }
        else if (j < 3) { r = 45; g = 212; b = 191; }
        else { r = 18; g = 120; b = 100; }

        ctx.fillStyle = `rgba(${r},${g},${b},${brightness})`;
        if (j === 0) {
          ctx.shadowColor = 'rgba(30, 247, 193, 0.6)';
          ctx.shadowBlur = 8;
        }
    ...
    waterGrad.addColorStop(0, 'rgba(19, 31, 45, 0.72)');
    waterGrad.addColorStop(1, 'rgba(7, 16, 24, 0.96)');
    ...
    ctx.strokeStyle = 'rgba(30, 247, 193, 0.2)';
    ctx.lineWidth = 1.5;
    ctx.stroke();
    ...
    for (const r of ripples) {
      ...
      for (let ring = 0; ring < 3; ring++) {
        ...
        ctx.strokeStyle = `rgba(30, 247, 193, ${alpha * (1 - ring * 0.3)})`;
